...
public class FilterProductHorizontal extends Filter {

    private AdapterProductHorizontal adapter;
    private ArrayList<ModelProduct> filterList;

    public FilterProductHorizontal(AdapterProductHorizontal adapter, ArrayList<ModelProduct> filterList) {
